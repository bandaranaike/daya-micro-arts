        ...
        <form class="w-full mx-auto max-w-lg">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <p v-if="errors.price" class="text-red-500 text-xs italic">Please fill out this field.</p>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded px-4 mb-3 leading-tight cursor-pointer bg-gray-50 focus:outline-none"
            ...
            <div class="flex flex-wrap -mx-3 mb-2">
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        id="grid-city" type="text" placeholder="Date">
                </div>
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
...
function saveProduct() {
    axios.post($route('art.store-art'), formData)
}
