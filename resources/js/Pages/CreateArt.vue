<template>
    ...
    <div class="w-full">
        <form class="w-full mx-auto max-w-lg">
            ...
            <div v-if="showSuccess" class="p-4 mb-4 mt-4 text-green-800 border border-green-600 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
                ...
                <div class="mt-2 mb-4 text-sm">
                    The art titled '{{createdArt.title}}' has been created and synced with Stripe. It is now ready for online selling.
                </div>
                <div class="flex">
                    <a :href="`/art/${createdArt.uuid}`" class="text-white bg-green-800 hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded text-xs px-3 py-1.5 me-2 text-center inline-flex items-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
